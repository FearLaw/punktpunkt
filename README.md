1. Schnittstelle via API, falls keine API vorhanden, ggf. Export von Daten via Format XML / CSV. Skript entwickeln und dieses dann in ein geeignetes Format für Typo3 konvertieren. 
